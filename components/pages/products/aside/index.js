...
function Aside() {
  ...
  return (
    <aside
      id="dropdowns"
      className="mobile-category w-screen h-screen max-md:fixed max-md:top-0 max-md:pt-32 max-md:px-16 max-md:bg-white flex-col hidden lg:flex gap-6 lg:w-2/5 p-4 border-[1px] rounded-md lg:h-max"
    >
      <span className="flex items-center gap-2 pb-2 text-lg font-medium cursor-pointer mobile-category-btn max-md:pb-8">
        <svg
