  ...
  return (
    <div>
      ...
      <main className="flex flex-col w-full gap-12 p-6 mx-auto mt-8 max-w-screen-2xl lg:px-12 xl:px-24 lg:flex-row lg:gap-8 lg:justify-between">
        <section className="flex flex-col gap-6 lg:w-7/12 xl:w-2/3">
          <div className="flex flex-col gap-4">
            <h1 className="text-lg font-bold lg:text-xl">
              آموزش صفر تا صد ایجاد اکانت پی پال از ایران
            </h1>
            <div className="flex gap-3">
              <span className="flex items-center gap-1 text-xs text-lowgray">
                <i>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
          ...
          <img
            ...
            alt=""
            className="w-full md:w-2/3 md:mx-auto lg:mx-0 lg:w-full rounded-md"
          />
          ...
          <a
            href="#"
            className="flex items-center gap-1 text-sm text-secondary lg:text-base"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
