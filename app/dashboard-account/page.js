    ...
    <div>
      ...
      <main class="w-full p-6 mx-auto max-w-screen-2xl lg:px-12 xl:px-24">
        <div class="flex gap-12">
          <aside class="w-full lg:border-[1px] lg:bg-white lg:w-1/5 lg:p-4 lg:rounded-md lg:h-max">
          ...
          <section class="hidden lg:flex flex-col gap-6 lg:w-4/5">
            ...
            <div class="text-sm bg-white px-8 py-4 rounded-md lg:border-[1px]">
              <h4 class="font-bold">اطلاعات شخصی</h4>
              <div class=" flex flex-wrap justify-between gap-2 mt-4 border-b-[1px] last:border-none pb-4">
                <span class="text-lowgray w-1/2">نام و نام خانوادگی:</span>
                <p class="order-2 w-1/2">ساغر صابری نژاد</p>
                <i class="order-1">
                  <svg
                    width="20"
                    height="20"
              ...
              <div class=" flex flex-wrap justify-between gap-2 mt-4 border-b-[1px] last:border-none pb-4">
                <span class="text-lowgray w-1/2">ایمیل</span>
                <p class="order-2 w-1/2">saghar.saberinezhad@gmail.com</p>
                <i class="order-1">
                  <svg
                    width="20"
                    height="20"
            ...
            <div class="text-sm bg-white px-8 py-4 rounded-md lg:border-[1px]">
              <h4 class="font-bold">اطلاعات امنیتی</h4>
              <div class=" flex flex-col gap-8 mt-4 pb-4">
                <a
                  href="#"
                  class="flex items-center gap-4 text-primary text-base w-max"
                >
                  تغییر رمز عبور
                  <i>
                    <svg
                ...
                <div class="flex gap-16">
                  <p class="text-lowgray">فعال سازی دو مرحله ای:</p>
                  <div class="flex justify-between items-center gap-2">
                    <input
                      ...
                      class="hidden peer"
                    />
                    <div class="w-4 h-4 rounded-full border-[1px] border-black mr-4 flex justify-center items-center before:w-3 before:h-3 before:rounded-full peer-checked:border-primary text-primary peer-checked:before:bg-primary"></div>
                    <label for="toman" class="peer-checked:text-primary">
                      رمز یکبار مصرف
                    </label>
                  </div>
                </div>
                <div class="flex items-center gap-2">
                  ...
                  <div class="w-4 h-4 rounded-full border-[1px] border-black mr-4 flex justify-center items-center before:w-3 before:h-3 before:rounded-full peer-checked:border-prtext-primary peer-checked:before:bg-primary"></div>
                  <label for="dollar" class="peer-checked:text-primary">
                    حساب گوگل
                  </label>
                </div>
              </div>
