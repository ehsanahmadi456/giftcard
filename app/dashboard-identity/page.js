      ...
      <main class="w-full p-6 mx-auto max-w-screen-2xl lg:px-12 xl:px-24">
        <div class="lg:flex gap-12">
          ...
          <section class="flex flex-col gap-6 lg:w-4/5">
            ...
            <div class="text-sm bg-white px-8 py-4 rounded-md lg:border-[1px]">
              <h4 class="font-bold">اطلاعات تماس</h4>
              <div class="flex flex-wrap justify-between gap-2 mt-4 border-b-[1px] last:border-none pb-4">
                <span class="text-lowgray w-1/2">شماره تلفن ثابت:</span>
                <p class="order-2 w-1/2">02166448546</p>
                <i class="order-1">
                  <svg
                    width="20"
                    height="20"
              ...
              <div class="flex flex-wrap lg:flex-nowrap justify-between gap-2 mt-4 border-b-[1px] last:border-none pb-4">
                <span class="text-lowgray w-1/2 lg:w-auto">
                  شماره تلفن همراه:
                </span>
                <p class="order-2 w-1/2 lg:w-auto lg:order-1">09351234567</p>
                <i class="order-1 lg:order-2">
                  <svg
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
            ...
            <div class="flex flex-col text-sm md:bg-white md:px-8 md:py-4 rounded-md lg:border-[1px] gap-4 w-full md:text-xs lg:text-sm">
              <a
                href="#"
                class="p-2 px-4 bg-primary mb-4 text-white rounded-sm w-max hover:bg-[#6352B8] transition-all duration-300 ease-linear"
              >
                <span class="text-lg ml-1">+</span> ثبت کارت بانکی
              </a>

              <h2 class="font-bold">کارت های بانکی شما</h2>

              <div class="items-center justify-between text-center gap-4 p-4 hidden md:flex">
                <p class="w-1/12">ردیف</p>
                <p class="w-1/12">بانک</p>
                <p class="w-3/12">شماره کارت</p>
                <p class="w-4/12">شماره شبا</p>
                <span class="w-3/12"></span>
              </div>
              <div class="bg-white rounded-md shadow-sm">
                <div class="flex flex-col gap-4 p-4 md:p-0 md:gap-2 text-center border-b-[1px] last:border-none md:border-none md:flex-row md:items-center md:justify-between md:py-0">
                  <p class="hidden md:block w-1/12">1</p>
                  <div class="flex gap-2 md:justify-center text-sm md:w-1/12">
                    <p class="text-lowgray md:hidden">بانک:</p>
                    <p>پاسارگاد</p>
                  </div>
                  <div class="flex gap-2 md:justify-center text-sm md:w-3/12">
                    <p class="text-lowgray md:hidden">شماره کارت:</p>
                    <p>5022291075907582</p>
                  </div>
                  <div class="flex gap-2 md:justify-center text-sm md:w-4/12">
                    <p class="text-lowgray md:hidden">شماره شبا:</p>
                    <p>IR502229107590758200000000</p>
                  </div>
                  <div class="flex items-center mt-2 md:mt-0 gap-6 md:justify-center md:w-3/12">
                    <a href="#" class="flex items-center gap-1 text-secondary">
                      <i>
                        <svg
                          width="20"
                          height="20"
                    ...
                    <a href="#" class="flex items-center gap-1 text-[#FF1A1A]">
