import HomeH from "@/public/assets/icons/HomeH";
    ...
    <div>
              ...
              <div className="relative group">
                ...
                >
                  ...
                  <i>
                    ...
                    >
                      <path
                        d="M11.9995 17.2999C11.2995 17.2999 10.5995 17.0299 10.0695 16.4999L3.54953 9.97989C3.25953 9.68989 3.25953 9.20989 3.54953 8.91989C3.83953 8.62989 4.31953 8.62989 4.60953 8.91989L11.1295 15.4399C11.6095 15.9199 12.3895 15.9199 12.8695 15.4399L19.3895 8.91989C19.6795 8.62989 20.1595 8.62989 20.4495 8.91989C20.7395 9.20989 20.7395 9.68989 20.4495 9.97989L13.9295 16.4999C13.3995 17.0299 12.6995 17.2999 11.9995 17.2999Z"
                        fill="#7A7A7A"
                      />
                    </svg>
                  </i>
                      ...
                      <span className="flex gap-1 items-center">
                        <i>
                          ...
                          >
                            ...
                            />
                            <path
                              d="M12.6753 18.9917C12.5003 18.9917 12.3253 18.9667 12.1503 18.9251C11.6337 18.7834 11.2003 18.4584 10.9253 18.0001L10.8253 17.8334C10.3337 16.9834 9.65866 16.9834 9.16699 17.8334L9.07533 17.9917C8.80033 18.4584 8.36699 18.7917 7.85033 18.9251C7.32533 19.0667 6.78366 18.9917 6.32533 18.7167L4.89199 17.8917C4.38366 17.6001 4.01699 17.1251 3.85866 16.5501C3.70866 15.9751 3.78366 15.3834 4.07533 14.8751C4.31699 14.4501 4.38366 14.0667 4.24199 13.8251C4.10033 13.5834 3.74199 13.4417 3.25033 13.4417C2.03366 13.4417 1.04199 12.4501 1.04199 11.2334V9.76674C1.04199 8.55008 2.03366 7.55841 3.25033 7.55841C3.74199 7.55841 4.10033 7.41674 4.24199 7.17508C4.38366 6.93341 4.32533 6.55008 4.07533 6.12508C3.78366 5.61674 3.70866 5.01674 3.85866 4.45008C4.00866 3.87508 4.37533 3.40008 4.89199 3.10841L6.33366 2.28341C7.27533 1.72508 8.51699 2.05008 9.08366 3.00841L9.18366 3.17508C9.67533 4.02508 10.3503 4.02508 10.842 3.17508L10.9337 3.01674C11.5003 2.05008 12.742 1.72508 13.692 2.29174L15.1253 3.11674C15.6337 3.40841 16.0003 3.88341 16.1587 4.45841C16.3087 5.03341 16.2337 5.62508 15.942 6.13341C15.7003 6.55841 15.6337 6.94174 15.7753 7.18341C15.917 7.42508 16.2753 7.56674 16.767 7.56674C17.9837 7.56674 18.9753 8.55841 18.9753 9.77508V11.2417C18.9753 12.4584 17.9837 13.4501 16.767 13.4501C16.2753 13.4501 15.917 13.5917 15.7753 13.8334C15.6337 14.0751 15.692 14.4584 15.942 14.8834C16.2337 15.3917 16.317 15.9917 16.1587 16.5584C16.0087 17.1334 15.642 17.6084 15.1253 17.9001L13.6837 18.7251C13.367 18.9001 13.0253 18.9917 12.6753 18.9917ZM10.0003 15.9084C10.742 15.9084 11.4337 16.3751 11.9087 17.2001L12.0003 17.3584C12.1003 17.5334 12.267 17.6584 12.467 17.7084C12.667 17.7584 12.867 17.7334 13.0337 17.6334L14.4753 16.8001C14.692 16.6751 14.8587 16.4667 14.9253 16.2167C14.992 15.9667 14.9587 15.7084 14.8337 15.4917C14.3587 14.6751 14.3003 13.8334 14.667 13.1917C15.0337 12.5501 15.792 12.1834 16.742 12.1834C17.2753 12.1834 17.7003 11.7584 17.7003 11.2251V9.75841C17.7003 9.23341 17.2753 8.80008 16.742 8.80008C15.792 8.80008 15.0337 8.43341 14.667 7.79174C14.3003 7.15008 14.3587 6.30841 14.8337 5.49174C14.9587 5.27508 14.992 5.01674 14.9253 4.76674C14.8587 4.51674 14.7003 4.31674 14.4837 4.18341L13.042 3.35841C12.6837 3.14174 12.2087 3.26674 11.992 3.63341L11.9003 3.79174C11.4253 4.61674 10.7337 5.08341 9.99199 5.08341C9.25033 5.08341 8.55866 4.61674 8.08366 3.79174L7.99199 3.62508C7.78366 3.27508 7.31699 3.15008 6.95866 3.35841L5.51699 4.19174C5.30033 4.31674 5.13366 4.52508 5.06699 4.77508C5.00033 5.02508 5.03366 5.28341 5.15866 5.50008C5.63366 6.31674 5.69199 7.15841 5.32533 7.80008C4.95866 8.44174 4.20033 8.80841 3.25033 8.80841C2.71699 8.80841 2.29199 9.23341 2.29199 9.76674V11.2334C2.29199 11.7584 2.71699 12.1917 3.25033 12.1917C4.20033 12.1917 4.95866 12.5584 5.32533 13.2001C5.69199 13.8417 5.63366 14.6834 5.15866 15.5001C5.03366 15.7167 5.00033 15.9751 5.06699 16.2251C5.13366 16.4751 5.29199 16.6751 5.50866 16.8084L6.95033 17.6334C7.12533 17.7417 7.33366 17.7667 7.52533 17.7167C7.72533 17.6667 7.89199 17.5334 8.00033 17.3584L8.09199 17.2001C8.56699 16.3834 9.25866 15.9084 10.0003 15.9084Z"
                              fill="#717171"
                            />
                          </svg>
                        </i>
      ...
      <main className="w-full">
        ...
        >
          <div className="flex flex-col gap-8 justify-items-start md:w-2/5">
            ...
            <p className="font-medium leading-loose text-lowgray">
              مجموعه ما به عنوان اولین فروشگاه خرید گیفت کارت های آیتونز اپل،
              گوگل پلی، پلی استیشن، استیم و ... این امکان را برای شما فراهم می
              کند تا بدون نیاز به کارت های بین المللی پرداخت های درون برنامه ای
              انجام دهید.
            </p>
            <a
              href="#"
              ...
              <div className="relative flex items-center justify-center image">
                <i>
                  ...
                  >
                    ...
                    />
                    <path
                      d="M12.917 20L17.6337 24.7167L27.0837 15.2833"
                      stroke="#786AC2"
                      strokeWidth="2"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                ...
                <div className="h-20 w-20 bg-[#F0EEF8] absolute rounded-full z-[-1]"></div>
              </div>
              <div className="mt-8 text-center description">
                <h4 className="py-2 text-lg font-bold">نماد الکترونیک</h4>
                <p className="text-lowgray">دارای مجوز نماد الکترونیک</p>
              </div>
            </div>
            <div className="flex flex-col items-center justify-center">
              <div className="relative flex items-center justify-center image">
                <i>
                  ...
                  >
                    <path
                      d="M29.5841 28.8333C26.7841 28.8333 24.2007 27.5166 22.5174 25.1999C22.1174 24.6499 22.2341 23.8666 22.7841 23.45C23.3341 23.0333 24.1174 23.1666 24.5341 23.7166C25.7508 25.3666 27.5841 26.3166 29.5841 26.3166C33.0674 26.3166 35.9174 23.4833 35.9174 19.9833C35.9174 16.4833 33.0841 13.6499 29.5841 13.6499C27.2174 13.6499 24.984 14.9166 23.7674 16.9332L19.3507 24.2833C17.6841 27.0666 14.6341 28.7833 11.4007 28.7833C6.53408 28.7833 2.56738 24.8166 2.56738 19.9499C2.56738 15.0832 6.53408 11.1166 11.4007 11.1166C14.2007 11.1166 16.7841 12.4332 18.4674 14.7499C18.8674 15.2999 18.7507 16.0833 18.2007 16.5C17.6341 16.9 16.8674 16.7833 16.4507 16.2333C15.2341 14.5833 13.4007 13.6333 11.4007 13.6333C7.91741 13.6333 5.06738 16.4666 5.06738 19.9666C5.06738 23.4666 7.90075 26.3 11.4007 26.3C13.7674 26.3 16.0007 25.0333 17.2174 23.0166L21.6341 15.6666C23.3007 12.8833 26.3507 11.1666 29.5841 11.1666C34.4508 11.1666 38.4174 15.1333 38.4174 19.9999C38.4174 24.8666 34.4508 28.8333 29.5841 28.8333Z"
                      fill="#F69625"
                    />
                  </svg>
                </i>
                <div className="h-20 w-20 bg-[#FDE8CF] absolute rounded-full z-[-1]"></div>
              </div>
              <div className="mt-8 text-center description">
                <h4 className="py-2 text-lg font-bold">تاریخ انقضای نامحدود</h4>
                <p className="text-lowgray">انقضای نامحدود محصولات</p>
              </div>
            </div>
            <div className="flex flex-col items-center justify-center">
              <div className="relative flex items-center justify-center image">
                <i>
                  ...
                  >
                    <path
                      d="M28.5091 24.5583C28.3581 24.5591 28.2116 24.5061 28.096 24.4089L23.2872 20.5144C23.2115 20.4517 23.1507 20.3731 23.1089 20.2842C23.0671 20.1953 23.0454 20.0983 23.0454 20.0001V9.23087C23.0454 9.05601 23.1149 8.8883 23.2385 8.76465C23.3622 8.641 23.5299 8.57153 23.7047 8.57153C23.8796 8.57153 24.0473 8.641 24.171 8.76465C24.2946 8.8883 24.3641 9.05601 24.3641 9.23087V19.688L28.9267 23.3847C29.0353 23.4715 29.1136 23.5904 29.1505 23.7244C29.1874 23.8584 29.1811 24.0007 29.1323 24.1308C29.0836 24.261 28.9949 24.3724 28.8791 24.4492C28.7632 24.526 28.626 24.5642 28.4872 24.5583H28.5091ZM17.085 27.2001H9.73112C9.55625 27.2001 9.38855 27.1306 9.2649 27.007C9.14125 26.8833 9.07178 26.7156 9.07178 26.5408C9.07178 26.3659 9.14125 26.1982 9.2649 26.0745C9.38855 25.9509 9.55625 25.8814 9.73112 25.8814H17.085C17.2598 25.8814 17.4275 25.9509 17.5512 26.0745C17.6748 26.1982 17.7443 26.3659 17.7443 26.5408C17.7443 26.7156 17.6748 26.8833 17.5512 27.007C17.4275 27.1306 17.2598 27.2001 17.085 27.2001ZM14.1004 20.1232H1.72672C1.55186 20.1232 1.38415 20.0537 1.2605 19.9301C1.13685 19.8064 1.06738 19.6387 1.06738 19.4638C1.06738 19.289 1.13685 19.1213 1.2605 18.9976C1.38415 18.874 1.55186 18.8045 1.72672 18.8045H14.1004C14.2752 18.8045 14.4429 18.874 14.5666 18.9976C14.6902 19.1213 14.7597 19.289 14.7597 19.4638C14.7597 19.6387 14.6902 19.8064 14.5666 19.9301C14.4429 20.0537 14.2752 20.1232 14.1004 20.1232ZM9.39266 12.9671H4.99705C4.82219 12.9671 4.65448 12.8977 4.53083 12.774C4.40718 12.6504 4.33771 12.4827 4.33771 12.3078C4.33771 12.1329 4.40718 11.9652 4.53083 11.8416C4.65448 11.7179 4.82219 11.6485 4.99705 11.6485H9.39266C9.56753 11.6485 9.73523 11.7179 9.85888 11.8416C9.98253 11.9652 10.052 12.1329 10.052 12.3078C10.052 12.4827 9.98253 12.6504 9.85888 12.774C9.73523 12.8977 9.56753 12.9671 9.39266 12.9671ZM23.7047 32.5276C23.5299 32.5276 23.3622 32.4581 23.2385 32.3345C23.1149 32.2108 23.0454 32.0431 23.0454 31.8682V31.7364C23.0454 31.5615 23.1149 31.3938 23.2385 31.2701C23.3622 31.1465 23.5299 31.077 23.7047 31.077C23.8796 31.077 24.0473 31.1465 24.171 31.2701C24.2946 31.3938 24.3641 31.5615 24.3641 31.7364V31.8682C24.3641 32.0431 24.2946 32.2108 24.171 32.3345C24.0473 32.4581 23.8796 32.5276 23.7047 32.5276ZM35.9861 20.6594H35.8542C35.6793 20.6594 35.5116 20.59 35.388 20.4663C35.2643 20.3427 35.1949 20.175 35.1949 20.0001C35.1949 19.8252 35.2643 19.6575 35.388 19.5339C35.5116 19.4102 35.6793 19.3408 35.8542 19.3408H35.9861C36.1609 19.3408 36.3286 19.4102 36.4523 19.5339C36.5759 19.6575 36.6454 19.8252 36.6454 20.0001C36.6454 20.175 36.5759 20.3427 36.4523 20.4663C36.3286 20.59 36.1609 20.6594 35.9861 20.6594Z"
                      fill="#786AC2"
                    />
                    <path
                      d="M8.32914 22.7957C8.17041 22.796 8.01694 22.7387 7.89727 22.6344C7.77761 22.5301 7.6999 22.3859 7.67859 22.2286C7.57721 21.4902 7.52874 20.7454 7.53354 20C7.53354 19.8252 7.60301 19.6575 7.72666 19.5338C7.85031 19.4102 8.01801 19.3407 8.19288 19.3407C8.36775 19.3407 8.53545 19.4102 8.6591 19.5338C8.78275 19.6575 8.85222 19.8252 8.85222 20C8.8523 20.6838 8.89929 21.3667 8.99288 22.044C9.00455 22.131 8.99871 22.2195 8.97572 22.3042C8.95274 22.389 8.91305 22.4683 8.85901 22.5375C8.80496 22.6067 8.73764 22.6644 8.66099 22.7072C8.58435 22.75 8.49992 22.7771 8.41266 22.7869L8.32914 22.7957ZM23.705 36.1803C21.5303 36.1879 19.3768 35.7535 17.3752 34.9035C15.3736 34.0534 13.5656 32.8054 12.061 31.2352C11.9607 31.1062 11.9118 30.9446 11.9239 30.7816C11.936 30.6187 12.0081 30.466 12.1264 30.3533C12.2446 30.2405 12.4006 30.1756 12.5639 30.1713C12.7272 30.1669 12.8864 30.2234 13.0105 30.3297C14.3925 31.7709 16.0533 32.9159 17.8919 33.695C19.7304 34.4741 21.7082 34.871 23.705 34.8616C26.3538 34.8608 28.9543 34.1521 31.2373 32.8089C33.5203 31.4656 35.4028 29.5366 36.6899 27.2214C37.977 24.9063 38.6219 22.2893 38.558 19.6412C38.494 16.9931 37.7235 14.4103 36.3261 12.16C34.9287 9.90971 32.9553 8.07381 30.6101 6.84231C28.265 5.61082 25.6333 5.0285 22.9875 5.15564C20.3417 5.28277 17.7779 6.11474 15.5616 7.56541C13.3454 9.01609 11.5571 11.0328 10.3819 13.4066C10.3038 13.5634 10.1666 13.6828 10.0005 13.7384C9.83438 13.7941 9.65298 13.7815 9.49618 13.7033C9.33938 13.6252 9.22003 13.488 9.16439 13.3219C9.10875 13.1558 9.12137 12.9744 9.19947 12.8176C10.479 10.2319 12.4264 8.03519 14.8401 6.45494C17.2538 4.87468 20.046 3.96833 22.9277 3.82973C25.8093 3.69112 28.6757 4.3253 31.2299 5.6666C33.7841 7.00791 35.9334 9.00757 37.4552 11.4586C38.9769 13.9095 39.8159 16.7227 39.8852 19.6069C39.9545 22.4911 39.2516 25.3413 37.8493 27.8626C36.447 30.3838 34.3962 32.4844 31.9094 33.9468C29.4225 35.4092 26.59 36.1803 23.705 36.1803ZM6.01266 27.2H4.81266C4.63779 27.2 4.47009 27.1306 4.34644 27.0069C4.22279 26.8833 4.15332 26.7156 4.15332 26.5407C4.15332 26.3658 4.22279 26.1981 4.34644 26.0745C4.47009 25.9508 4.63779 25.8814 4.81266 25.8814H6.01266C6.18753 25.8814 6.35523 25.9508 6.47889 26.0745C6.60254 26.1981 6.672 26.3658 6.672 26.5407C6.672 26.7156 6.60254 26.8833 6.47889 27.0069C6.35523 27.1306 6.18753 27.2 6.01266 27.2Z"
                      fill="#786AC2"
                    />
                    <path
                      d="M8.93138 15.6836C8.82036 15.6823 8.71144 15.6532 8.61459 15.5989C8.51774 15.5446 8.43606 15.4669 8.37702 15.3728C8.31797 15.2788 8.28346 15.1715 8.27664 15.0607C8.26982 14.9498 8.29091 14.8391 8.33798 14.7385L9.25226 12.8264C9.2895 12.7482 9.34177 12.6781 9.4061 12.6201C9.47043 12.5621 9.54555 12.5173 9.62719 12.4883C9.70882 12.4593 9.79537 12.4467 9.88188 12.4512C9.96839 12.4557 10.0532 12.4771 10.1314 12.5144C10.2096 12.5516 10.2797 12.6039 10.3377 12.6682C10.3957 12.7325 10.4405 12.8076 10.4695 12.8893C10.4985 12.9709 10.5111 13.0575 10.5066 13.144C10.5022 13.2305 10.4807 13.3153 10.4435 13.3935L9.52919 15.31C9.47469 15.4221 9.38971 15.5166 9.28399 15.5827C9.17826 15.6488 9.05606 15.6837 8.93138 15.6836Z"
                      fill="#786AC2"
                    />
                  </svg>
                </i>
              ...
              <div className="mt-8 text-center description">
                <h4 className="py-2 text-lg font-bold">تحویل فوری</h4>
                <p className="text-lowgray">تحویل فوری پس از خرید</p>
              </div>
            </div>
            <div className="flex flex-col items-center justify-center">
              <div className="relative flex items-center justify-center image">
                <i>
                  ...
                  >
                    <path
                      d="M9.78285 37.8334C5.88285 37.8334 2.58285 34.5334 2.58285 30.6334V20.3667C2.49951 15.5 4.29951 10.9167 7.66618 7.48336C9.32817 5.78997 11.3128 4.44698 13.5027 3.53379C15.6927 2.6206 18.0435 2.15574 20.4162 2.16669C30.3495 2.16669 38.4162 10.25 38.4162 20.1667V30.4334C38.4162 34.4 35.1828 37.6334 31.2162 37.6334C27.3162 37.6334 24.0162 34.3334 24.0162 30.4334V25.75C24.0162 23.3334 25.9162 21.4334 28.3328 21.4334C30.7495 21.4334 32.6495 23.3334 32.6495 25.75V30.8C32.6495 31.4834 32.0828 32.05 31.3995 32.05C30.7162 32.05 30.1495 31.4834 30.1495 30.8V25.75C30.1495 24.6167 29.2328 23.9334 28.3328 23.9334C27.1995 23.9334 26.5162 24.85 26.5162 25.75V30.4334C26.5162 32.9834 28.6662 35.1334 31.2162 35.1334C33.7662 35.1334 35.9162 32.9834 35.9162 30.4334V20.1667C35.9162 11.6167 28.9662 4.66669 20.4162 4.66669C16.2328 4.66669 12.3495 6.28336 9.44951 9.23336C6.54951 12.1834 4.99951 16.1334 5.08285 20.3334V30.6334C5.08285 33.1834 7.23285 35.3334 9.78285 35.3334C12.3328 35.3334 14.4828 33.1834 14.4828 30.6334V25.95C14.4828 24.8167 13.5662 24.1334 12.6662 24.1334C11.5328 24.1334 10.8495 25.05 10.8495 25.95V30.8167C10.8495 31.5 10.2828 32.0667 9.59951 32.0667C8.91618 32.0667 8.34951 31.5 8.34951 30.8167V25.95C8.34951 23.5334 10.2495 21.6334 12.6662 21.6334C15.0828 21.6334 16.9828 23.5334 16.9828 25.95V30.6334C16.9828 34.5334 13.6828 37.8334 9.78285 37.8334Z"
                      fill="#F69625"
                    />
                  </svg>
                </i>
              ...
              <div className="mt-8 text-center description">
                <h4 className="py-2 text-lg font-bold">پشتیبانی آنلاین</h4>
                <p className="text-lowgray">پشتیبانی ۲۴ ساعته آنلاین</p>
              </div>
            </div>
          </div>
        </section>
        ...
        >
          <article className="flex flex-col items-center justify-center gap-8 mb-16 overflow-visible swiper--1">
            ...
            <div className="flex w-full swiper-wrapper md:gap-4">
              ...
              <a
                href="#"
                className="flex-shrink-0 w-2/5 p-3 text-center transition-all duration-300 ease-linear bg-white rounded-md swiper-slide md:w-1/4 md:flex-shrink hover:shadow-md"
              >
                <img
                  src="./assets/img/product.png"
                  className="rounded-md"
          ...
          <article className="flex flex-col items-center justify-center gap-8 mb-16 overflow-visible swiper--2">
            <div className="flex items-center justify-between w-full">
              <h4 className="text-lg font-bold md:text-xl">
                گیفت کارت های موزیک
              </h4>
          ...
          <article className="flex flex-col items-center justify-center gap-8 mb-16 overflow-visible swiper--3">
            <div className="flex items-center justify-between w-full">
              <h4 className="text-lg font-bold md:text-xl">
                گیفت کارت های موزیک
              </h4>
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-12 mt-16 lg:grid-cols-2 lg:grid-rows-3">
            <article className="flex flex-col max-w-lg gap-6 mx-auto lg:row-span-3 lg:max-w-none">
              <img src="./assets/img/blog.png" className="rounded-lg" alt="" />
              <div className="flex flex-col gap-6">
                <h6 className="font-medium">
                  بررسی ایکس باکس سری اس مایکروسافت
                </h6>
                <p className="hidden text-lowgray lg:block">
                  مایکروسافت با ایکس باکس سری اس، می‌خواهد تجربه‌ی نسل نهم
                  کنسول‌های بازی را در ازای پرداخت مبلغ معقولی، برای کاربر
                  به‌ارمغان آورد. ایکس باکس سری اس لقب ارزان‌ترین کنسول بازی نسل
                  نهم را یدک می‌کشد.
                </p>
                <div className="flex justify-between">
            ...
            <article className="flex flex-col max-w-lg gap-6 mx-auto lg:flex-row lg:row-span-1 lg:max-w-none">
              <img
                ...
                className="rounded-lg lg:w[160px] lg:h-[140px]"
                alt=""
              />
              <div className="flex flex-col gap-6">
                <h6 className="font-medium">
            ...
            <div className="flex items-center justify-between w-full">
              ...
              <div className="flex flex-col items-center justify-center max-w-lg gap-4 text-sm profile text-lowgray">
                ...
                <p className="font-medium leading-loose text-center text-black">
                  کارشون خیلی خوبه من بارها از اینجا گیفت آیتونز خریدم! فقط کاش
                  روی بعضی محصولات تخفیف می گذاشتید.
                </p>
              </div>
              <span className="p-2 bg-white rounded-sm shadow-md">
                <i>
        ...
        >
          ...
          <div className="group flex flex-col p-4 gap-4 border-[1px] rounded-md">
            <div className="flex items-center gap-2 action-button">
              ...
              <h6>چگونه به تراکنش های خود دسترسی داشته باشم؟</h6>
            </div>
            <p className="hidden text-lowgray text-sm group-[.active]:block">
              شما می توانید با رفتن به حساب کاربری و بخش تراکنش ها لیست گزارش
