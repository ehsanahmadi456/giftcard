  ...
  return (
    <div>
      ...
      <main class="w-full p-6 mx-auto max-w-screen-2xl lg:px-12 xl:px-24">
        <section class="grid justify-center w-full max-w-md grid-cols-1 gap-8 mx-auto mt-16 mb-12 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 md:max-w-xl lg:max-w-full">
          <h4 class="text-lg font-bold md:col-span-full">
            کشور مورد نظر را انتخاب کنید:
          </h4>
          <div class="p-4 bg-white rounded-md">
            <a
              href="#"
              class="flex items-center gap-4 font-medium max-md:justify-center"
            >
              <img src="./assets/img/country.png" class="h-8 w-14" alt="" />
              <span>گیفت کارت اپل آمریکا</span>
            </a>
          </div>
          <div class="p-4 bg-white rounded-md">
            <a
