...
function OrderDetail() {
  return (
    <div>
      ...
      <main class="flex flex-col w-full mx-auto mt-6 mb-12 max-w-screen-2xl lg:flex-row">
        <div class="p-6 lg:px-8 xl:pr-24 lg:w-3/5">
          ...
          >
            ...
            <article class="flex justify-between items-center border-b-[1px] pb-8 lg:border-0">
              <div class="flex items-center gap-2 font-medium">
                <img
                  src="./assets/img/xbox.png"
                  alt=""
        ...
        <div class="sticky bottom-0 pt-6 lg:px-8 xl:pl-24 lg:w-2/5 lg:block">
          <section id="confirm-pay" class="sticky bottom-0">
            <div class="flex flex-row-reverse justify-between items-center bg-white p-8 border-t-[1px] border-b-[1px] text-sm lg:border-[1px] lg:flex-col lg:items-start lg:gap-16 lg:pb-16">
              <h4 class="hidden font-medium lg:text-lg lg:block">
                پرداخت نهایی
              </h4>
              <div class="flex justify-between font-medium lg:w-full">
                <span class="hidden text-lowgray lg:block">
                  مبلغ قابل پرداخت
                </span>
                ۴۳۶٬۵۰۰ تومان
              </div>
