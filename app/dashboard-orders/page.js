            ...
            <div class="lg:flex gap-12">
				<aside class="hidden lg:block w-full lg:border-[1px] lg:bg-white lg:w-1/5 lg:p-4 lg:rounded-md lg:h-max">
					<div class="flex flex-col gap-4 items-center">
						<img src="./assets/img/user.png" alt="user profile" class="w-20 h-20 rounded-full"/>
						...
						<div class="flex flex-col gap-4 items-center">
							<i class="w-8 h-8 bg-[#4FA8EA] flex justify-center items-center rounded-full">
								<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path d="M11 5.75337C10.7267 5.75337 10.5 5.5267 10.5 5.25337V4.33337C10.5 3.63337 10.2 2.95337 9.68 2.48004C9.15333 2.00004 8.47333 1.78004 7.75333 1.8467C6.55333 1.96004 5.5 3.1867 5.5 4.4667V5.11337C5.5 5.3867 5.27333 5.61337 5 5.61337C4.72667 5.61337 4.5 5.3867 4.5 5.11337V4.46004C4.5 2.6667 5.94667 1.01337 7.66 0.846703C8.66 0.75337 9.62 1.0667 10.3533 1.74004C11.08 2.40004 11.5 3.3467 11.5 4.33337V5.25337C11.5 5.5267 11.2733 5.75337 11 5.75337Z" fill="white"/>
									<path d="M10 15.1666H6C2.92 15.1666 2.34667 13.7333 2.2 12.3399L1.7 8.34659C1.62667 7.62659 1.6 6.59325 2.3 5.81992C2.9 5.15325 3.89333 4.83325 5.33333 4.83325H10.6667C12.1133 4.83325 13.1067 5.15992 13.7 5.81992C14.3933 6.59325 14.3733 7.62659 14.3 8.33325L13.8 12.3399C13.6533 13.7333 13.08 15.1666 10 15.1666ZM5.33333 5.83325C4.20667 5.83325 3.43333 6.05325 3.04 6.49325C2.71333 6.85325 2.60667 7.40659 2.69333 8.23325L3.19333 12.2266C3.30667 13.2933 3.6 14.1733 6 14.1733H10C12.4 14.1733 12.6933 13.2999 12.8067 12.2399L13.3067 8.23325C13.3933 7.41992 13.2867 6.86659 12.96 6.49992C12.5667 6.05325 11.7933 5.83325 10.6667 5.83325H5.33333Z" fill="white"/>
									<path d="M10.28 8.76668C9.90669 8.76668 9.60669 8.46668 9.60669 8.10002C9.60669 7.73335 9.90669 7.43335 10.2734 7.43335C10.64 7.43335 10.94 7.73335 10.94 8.10002C10.94 8.46668 10.6467 8.76668 10.28 8.76668Z" fill="white"/>
									<path d="M5.61327 8.76668C5.23994 8.76668 4.93994 8.46668 4.93994 8.10002C4.93994 7.73335 5.23994 7.43335 5.60661 7.43335C5.97327 7.43335 6.27327 7.73335 6.27327 8.10002C6.27327 8.46668 5.97994 8.76668 5.61327 8.76668Z" fill="white"/>
								</svg>						
							</i>
							<div class="flex flex-col justify-center items-center gap-2">
					...
					<div class="flex flex-col gap-4 mt-12 text-sm">
						...
						<a
							...
							<span class="flex gap-1 items-center">
								<i>
									<svg width="20" height="20" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M13.75 7.69159C13.4083 7.69159 13.125 7.40826 13.125 7.06659V5.91659C13.125 5.04159 12.75 4.19159 12.1 3.59992C11.4417 2.99992 10.5917 2.72492 9.69167 2.80826C8.19167 2.94992 6.875 4.48326 6.875 6.08326V6.89159C6.875 7.23326 6.59167 7.51659 6.25 7.51659C5.90833 7.51659 5.625 7.23326 5.625 6.89159V6.07492C5.625 3.83326 7.43333 1.76659 9.575 1.55826C10.825 1.44159 12.025 1.83326 12.9417 2.67492C13.85 3.49992 14.375 4.68326 14.375 5.91659V7.06659C14.375 7.40826 14.0917 7.69159 13.75 7.69159Z" fill="#717171"/>
										<path d="M12.5 19.4584H7.49997C3.64997 19.4584 2.9333 17.6667 2.74997 15.9251L2.12497 10.9334C2.0333 10.0334 1.99997 8.74175 2.87497 7.77508C3.62497 6.94175 4.86664 6.54175 6.66664 6.54175H13.3333C15.1416 6.54175 16.3833 6.95008 17.125 7.77508C17.9916 8.74175 17.9666 10.0334 17.875 10.9167L17.25 15.9251C17.0666 17.6667 16.35 19.4584 12.5 19.4584ZM6.66664 7.79175C5.2583 7.79175 4.29164 8.06675 3.79997 8.61675C3.39164 9.06675 3.2583 9.75842 3.36664 10.7917L3.99164 15.7834C4.1333 17.1167 4.49997 18.2167 7.49997 18.2167H12.5C15.5 18.2167 15.8666 17.1251 16.0083 15.8001L16.6333 10.7917C16.7416 9.77508 16.6083 9.08342 16.2 8.62508C15.7083 8.06675 14.7416 7.79175 13.3333 7.79175H6.66664Z" fill="#717171"/>
										<path d="M12.85 11.4584C12.3834 11.4584 12.0084 11.0834 12.0084 10.6251C12.0084 10.1667 12.3834 9.79175 12.8417 9.79175C13.3 9.79175 13.675 10.1667 13.675 10.6251C13.675 11.0834 13.3084 11.4584 12.85 11.4584Z" fill="#717171"/>
										<path d="M7.01665 11.4584C6.54999 11.4584 6.17499 11.0834 6.17499 10.6251C6.17499 10.1667 6.54999 9.79175 7.00832 9.79175C7.46665 9.79175 7.84165 10.1667 7.84165 10.6251C7.84165 11.0834 7.47499 11.4584 7.01665 11.4584Z" fill="#717171"/>
									</svg>
								</i>
								سفارش ها
							</span>
						...
						<a
							...
							<span class="flex gap-1 items-center">
								<i>
									<svg width="20" height="20" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M14.5333 13.3083C14.375 13.3083 14.2167 13.25 14.0917 13.125C13.85 12.8833 13.85 12.4833 14.0917 12.2416L15.7833 10.55L14.0917 8.85828C13.85 8.61662 13.85 8.21662 14.0917 7.97495C14.3333 7.73328 14.7333 7.73328 14.975 7.97495L17.1083 10.1083C17.35 10.35 17.35 10.75 17.1083 10.9916L14.975 13.125C14.85 13.25 14.6917 13.3083 14.5333 13.3083Z" fill="#717171"/>
										<path d="M16.6084 11.175H8.13336C7.7917 11.175 7.50836 10.8917 7.50836 10.55C7.50836 10.2084 7.7917 9.92505 8.13336 9.92505H16.6084C16.95 9.92505 17.2334 10.2084 17.2334 10.55C17.2334 10.8917 16.95 11.175 16.6084 11.175Z" fill="#717171"/>
										<path d="M9.80003 17.7916C5.50836 17.7916 2.50836 14.7916 2.50836 10.4999C2.50836 6.20825 5.50836 3.20825 9.80003 3.20825C10.1417 3.20825 10.425 3.49159 10.425 3.83325C10.425 4.17492 10.1417 4.45825 9.80003 4.45825C6.2417 4.45825 3.75836 6.94159 3.75836 10.4999C3.75836 14.0583 6.2417 16.5416 9.80003 16.5416C10.1417 16.5416 10.425 16.8249 10.425 17.1666C10.425 17.5083 10.1417 17.7916 9.80003 17.7916Z" fill="#717171"/>
									</svg>
								</i>
								خروج
							</span>
				...
				<section class="flex flex-col gap-6 lg:w-4/5">
					...
					<div class="flex flex-col text-sm md:bg-white px-8 py-4 rounded-md lg:border-[1px] gap-4 w-full">
                        <h2 class="font-bold">تاریخچه سفارشات</h2>
                        <div class="flex flex-col text-lowgray gap-8 md:flex-row md:items-center">
                            <div class="flex items-center gap-2">
                                <i>
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9.58335 18.1248C4.87502 18.1248 1.04169 14.2915 1.04169 9.58317C1.04169 4.87484 4.87502 1.0415 9.58335 1.0415C14.2917 1.0415 18.125 4.87484 18.125 9.58317C18.125 14.2915 14.2917 18.1248 9.58335 18.1248ZM9.58335 2.2915C5.55835 2.2915 2.29169 5.5665 2.29169 9.58317C2.29169 13.5998 5.55835 16.8748 9.58335 16.8748C13.6084 16.8748 16.875 13.5998 16.875 9.58317C16.875 5.5665 13.6084 2.2915 9.58335 2.2915Z" fill="#717171"/>
                                        <path d="M18.3333 18.9585C18.175 18.9585 18.0167 18.9002 17.8917 18.7752L16.225 17.1085C15.9833 16.8669 15.9833 16.4669 16.225 16.2252C16.4667 15.9835 16.8667 15.9835 17.1083 16.2252L18.775 17.8919C19.0167 18.1335 19.0167 18.5335 18.775 18.7752C18.65 18.9002 18.4917 18.9585 18.3333 18.9585Z" fill="#717171"/>
                                    </svg>                                        
                                </i>
                                <span>جستجوی سفارش ها:</span>
                            </div>
                            <div class="flex md:gap-6">
                                <input type="date" class="bg-transparent w-1/2 border-[1px] rounded-sm text-center py-2 px-4" />
                                <input type="date" class="bg-transparent w-1/2 border-[1px] rounded-sm text-center py-2 px-4" />
                            </div>
                        </div>

						<div class="justify-around items-center text-center gap-4 p-4 hidden md:flex">
							<p class="w-1/12">ردیف</p>
							<p class="w-3/12">وضعیت</p>
							<p class="w-3/12">مبلغ</p>
							<p class="w-3/12">تاریخ</p>
							<p class="w-2/12">فاکتور</p>
						</div>
						<div class="bg-white flex flex-col gap-8 p-4 w-full shadow-md rounded-md text-center md:gap-4 md:bg-transparent md:shadow-none md:flex-row md:items-center md:justify-between md:py-0">
                            <p class="w-1/12 hidden md:block">1</p>
							<span class="py-2 px-8 bg-success-bg w-max text-success-text md:w-3/12 text-center">شارژ</span>
                            <div class="flex justify-between md:justify-center text-sm md:w-3/12">
                                <p class="text-lowgray md:hidden">مبلغ</p>
                                <p class="font-semibold">+ ۲۰٬۰۰۰ تومان</p>
                            </div>
                            <div class="flex justify-between md:justify-center text-sm md:w-3/12">
                                <p class="text-lowgray md:hidden">تاریخ</p>
                                <p class="font-semibold">۱۴:۲۵:۰۰ - ۱۴۰۰/۰۵/۱۰</p>
                            </div>
                            <div class="flex justify-between text-sm md:w-2/12 md:justify-center">
                                <p class="text-lowgray md:hidden">فاکتور</p>
                                <div class="flex gap-1 items-center text-[#4FA8EA]">
                                    <p>مشاهده</p>
                                    <i>
                                        <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M12.5 17.2248C12.3417 17.2248 12.1834 17.1664 12.0584 17.0414L6.62502 11.6081C5.74169 10.7248 5.74169 9.27477 6.62502 8.39144L12.0584 2.95811C12.3 2.71644 12.7 2.71644 12.9417 2.95811C13.1834 3.19977 13.1834 3.59977 12.9417 3.84144L7.50836 9.27477C7.10836 9.67477 7.10836 10.3248 7.50836 10.7248L12.9417 16.1581C13.1834 16.3998 13.1834 16.7998 12.9417 17.0414C12.8167 17.1581 12.6584 17.2248 12.5 17.2248Z" fill="#4FA8EA"/>
                                        </svg> 
                                    </i>
                                </div>
                            </div>
                        ...
                        <div class="bg-white flex flex-col gap-8 p-4 w-full shadow-md rounded-md text-center md:gap-4 md:bg-transparent md:shadow-none md:flex-row md:items-center md:justify-between md:py-0">
                            <p class="w-1/12 hidden md:block">1</p>
							<span class="py-2 px-8 bg-danger-bg w-max text-danger-text md:w-3/12 text-center">خرید</span>
                            <div class="flex justify-between md:justify-center text-sm md:w-3/12">
                                <p class="text-lowgray md:hidden">مبلغ</p>
                                <p class="font-semibold">+ ۲۰٬۰۰۰ تومان</p>
                            </div>
                        ...
                        <div class="bg-white flex flex-col gap-8 p-4 w-full shadow-md rounded-md text-center md:gap-4 md:bg-transparent md:shadow-none md:flex-row md:items-center md:justify-between md:py-0">
                            <p class="w-1/12 hidden md:block">1</p>
							<span class="py-2 px-8 bg-warn-bg w-max text-warn-text md:w-3/12 text-center">جایزه</span>
                            <div class="flex justify-between md:justify-center text-sm md:w-3/12">
                                <p class="text-lowgray md:hidden">مبلغ</p>
                                <p class="font-semibold">+ ۲۰٬۰۰۰ تومان</p>
                            </div>
