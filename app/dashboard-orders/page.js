          ...
          <section className="flex flex-col gap-6 lg:w-4/5">
            ...
            <div className="flex flex-col text-sm md:bg-white px-8 py-4 rounded-md lg:border-[1px] gap-4 w-full">
              ...
              <div className="bg-white flex flex-col gap-8 p-4 w-full shadow-md rounded-md text-center md:gap-4 md:bg-transparent md:shadow-none md:flex-row md:items-center md:justify-between md:py-0">
                ...
                <span className="py-2 px-8 bg-success-bg w-max text-success-text md:w-3/12 text-center">
                  شارژ
                </span>
                <div className="flex justify-between md:justify-center text-sm md:w-3/12">
                  <p className="text-lowgray md:hidden">مبلغ</p>
                  <p className="font-semibold">+ ۲۰٬۰۰۰ تومان</p>
                </div>
                <div className="flex justify-between md:justify-center text-sm md:w-3/12">
                  <p className="text-lowgray md:hidden">تاریخ</p>
                  <p className="font-semibold">۱۴:۲۵:۰۰ - ۱۴۰۰/۰۵/۱۰</p>
                </div>
              ...
              <div className="bg-white flex flex-col gap-8 p-4 w-full shadow-md rounded-md text-center md:gap-4 md:bg-transparent md:shadow-none md:flex-row md:items-center md:justify-between md:py-0">
                <p className="w-1/12 hidden md:block">1</p>
                <span className="py-2 px-8 bg-danger-bg w-max text-danger-text md:w-3/12 text-center">
                  خرید
                </span>
                <div className="flex justify-between md:justify-center text-sm md:w-3/12">
                  <p className="text-lowgray md:hidden">مبلغ</p>
              ...
              <div className="bg-white flex flex-col gap-8 p-4 w-full shadow-md rounded-md text-center md:gap-4 md:bg-transparent md:shadow-none md:flex-row md:items-center md:justify-between md:py-0">
                <p className="w-1/12 hidden md:block">1</p>
                <span className="py-2 px-8 bg-warn-bg w-max text-warn-text md:w-3/12 text-center">
                  جایزه
                </span>
                <div className="flex justify-between md:justify-center text-sm md:w-3/12">
                  <p className="text-lowgray md:hidden">مبلغ</p>
