    ...
    <div>
      ...
      <main className="w-full mx-auto mb-12 max-w-screen-2xl">
        ...
        <div className="flex justify-center gap-2 mt-12">
          <a href="#" className="px-4 py-2 text-white rounded-md bg-primary">
            1
          </a>
          <a
            href="#"
            className="bg-white text-lowgray px-4 py-2 rounded-md border-[1px]"
          >
            2
          </a>
          <a
        ...
        <aside className="p-6 mt-12 lg:px-12 xl:px-24">
          ...
          <div className="grid grid-cols-1 gap-4 mx-auto md:grid-cols-2 lgp:grid-cols-3 sm:max-w-md md:max-w-full">
            <article className="flex items-center px-3 py-4 transition-all duration-100 bg-white rounded-md gap-4 cursor-pointer hover:shadow-md">
              <img
                src="../public/assets/images/xbox-red.png"
                className="w-20 rounded-md lg:w-24"
                alt=""
              />
              <div className="flex flex-col gap-4">
                <h4 className="text-sm font-medium">ساخت مستر کارت در ایران</h4>
