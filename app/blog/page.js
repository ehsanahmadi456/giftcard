...
function Blog() {
  return (
    <div>
      ...
      <main class="w-full mx-auto mb-12 max-w-screen-2xl">
        <section
          id="best"
          class="hidden w-full mb-12 max-w-screen-2xl lg:px-12 xl:px-24 mx-auto mt-6 lg:grid grid-cols-4 grid-rows-2 gap-4 rounded-lg text-white lg:h-80 xl:h-96 2xl:h-[430px]"
        >
          <div class="relative col-span-2 row-span-2 overflow-hidden rounded-lg block z-10 bg-[url('../public/assets/images/blog.png')] bg-cover bg-no-repeat bg-center before:content-[''] before:absolute before:inset-0 before:block before:bg-gradient-to-t before:from-slate-800 before:from-10% before:opacity-60 before:z-[-5]">
            <p class="absolute text-xl font-medium bottom-6 right-6">
              بررسی ایکس باکس سری اس مایکروسافت
            </p>
          </div>
          <div class="relative overflow-hidden rounded-lg block z-10 bg-[url('../public/assets/images/blog.png')] bg-cover bg-no-repeat bg-center before:content-[''] before:absolute before:inset-0 before:block before:bg-gradient-to-t before:from-slate-800 before:from-10% before:opacity-60 before:z-[-5]">
            <p class="absolute font-medium bottom-4 right-4">
        ...
        <section
          id="all-blog"
          class="grid grid-cols-1 p-6 sm:grid-cols-2 lg:grid-cols-3 sm:gap-4 lg:px-12 xl:px-24"
        >
          <article class="flex flex-col gap-4 p-6 overflow-hidden transition-all duration-100 ease-linear sm:rounded-lg sm:bg-white sm:max-w-md sm:p-0 hover:shadow-md">
            <img
              src="./assets/img/blog.png"
              class="rounded-lg lg:rounded-none"
              alt=""
            />
            <div class="flex flex-col gap-4 p-4">
              <h6 class="font-medium">بررسی ایکس باکس سری اس مایکروسافت</h6>
              <p class="hidden text-sm md:block text-lowgray">
                مایکروسافت با ایکس باکس سری اس، می‌خواهد تجربه‌ی نسل نهم
                کنسول‌های بازی را در ازای پرداخت مبلغ...
              </p>
              <div class="flex justify-between">
                <div class="flex gap-3 text-xs">
                  <span class="flex items-center justify-center gap-1 text-lowgray">
                    <i>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                ...
                <a
                  href="#"
                  class="flex items-center justify-center text-xs text-primary lg:justify-start"
                >
                  متن کامل
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="flex justify-center gap-2 mt-12">
          ...
          <a
            href="#"
            class="bg-white text-lowgray px-4 py-2 rounded-md border-[1px]"
          >
            2
          </a>
          <a
        ...
        <aside class="p-6 mt-12 lg:px-12 xl:px-24">
          <h6 class="mb-4 font-medium">پربازدیدترین ها</h6>
          <div class="grid grid-cols-1 gap-4 mx-auto md:grid-cols-2 lgp:grid-cols-3 sm:max-w-md md:max-w-full">
            <article class="flex items-center px-3 py-4 transition-all duration-100 bg-white rounded-md gap-4 cursor-pointer hover:shadow-md">
              <img
                src="./assets/img/xbox-red.png"
                class="w-20 rounded-md lg:w-24"
                alt=""
              />
              <div class="flex flex-col gap-4">
                <h4 class="text-sm font-medium">ساخت مستر کارت در ایران</h4>
                <div class="flex gap-2 md:gap-4">
                  <span class="flex items-center gap-1 text-[10px] text-lowgray">
                    <img src="./assets/img/calendar.svg" alt="" />
                    تاریخ انتشار: ۱۴۰۲/۰۳/۱۶
                  </span>
                  <span class="flex items-center gap-1 text-[10px] text-lowgray">
                    <img src="./assets/img/calendar.svg" alt="" />
                    تعداد بازدید: ۱۶۲
