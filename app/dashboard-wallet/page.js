              ...
              <div className="md:flex md:flex-col md:gap-2 rounded-md shadow-sm md:shadow-none">
                <div className="flex flex-col gap-8 p-4 md:p-0 md:gap-2 text-center border-b-[1px] last:border-none md:border-none md:flex-row md:items-center md:justify-between md:py-0">
                  <div className="flex items-center justify-between md:justify-center md:w-3/12">
                    <span className="py-2 px-8 bg-success-bg w-24 text-success-text text-center md:hidden">
                      موفق
                    </span>
                  ...
                  <div className="flex justify-between md:justify-center text-sm md:w-2/12">
                    <p className="text-lowgray md:hidden">
                      مقدار واریزی (تومان)
                    </p>
                    <p>۵۴۳٬۰۰۰</p>
                  </div>
                  <div className="hidden md:flex justify-between md:justify-center text-sm md:w-2/12">
                    ...
                    <span className="py-2 px-8 bg-success-bg w-24 text-success-text text-center">
                      موفق
                    </span>
                  </div>
                ...
                <div className="flex flex-col gap-8 p-4 md:p-0 md:gap-2 text-center border-b-[1px] last:border-none md:border-none md:flex-row md:items-center md:justify-between md:py-0">
                  <div className="flex items-center justify-between md:justify-center md:w-3/12">
                    <span className="py-2 px-8 bg-danger-bg w-24 text-danger-text text-center md:hidden">
                      ناموفق
                    </span>
                    <span>۱۴:۲۵:۰۰ - ۱۴۰۰/۰۵/۱۰</span>
                  </div>
                  ...
                  <div className="hidden md:flex justify-between md:justify-center text-sm md:w-2/12">
                    ...
                    <span className="py-2 px-8 bg-danger-bg w-24 text-danger-text text-center">
                      ناموفق
                    </span>
                  </div>
                  <div className="flex justify-between md:justify-center text-sm md:w-4/12">
