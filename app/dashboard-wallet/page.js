      ...
      <main class="w-full p-6 mx-auto max-w-screen-2xl lg:px-12 xl:px-24">
        <div class="lg:flex gap-12">
          ...
          <section class="flex flex-col gap-6 lg:w-4/5">
            ...
            <div class="flex flex-col text-sm bg-white p-8 rounded-md lg:border-[1px] gap-4 w-full shadow-sm max-w-sm md:max-w-md lg:max-w-lg">
              <div class="mx-auto border-2 border-primary overflow-hidden flex justify-center items-center rounded-md mb-4">
                <a
                  href="#"
                  class="active p-2 px-4 [&.active]:bg-primary [&.active]:text-white bg-white rounded-sm w-max [&.active]:hover:bg-[#6352B8] hover:bg-[#6352B8] hover:text-white transition-all duration-300 ease-linear"
                >
                  <span class="text-lg ml-1">+</span> ثبت کارت بانکی
                </a>
                <a
                  href="#"
                  class="p-2 px-4 [&.active]:bg-primary [&.active]:text-white bg-white rounded-sm w-max [&.active]:hover:bg-[#6352B8] hover:bg-[#6352B8] hover:text-white transition-all duration-300 ease-linear"
                >
                  <span class="text-lg ml-1">+</span> ثبت کارت بانکی
                </a>
              </div>
              <form action="" class="flex flex-col gap-8">
                <div class="relative p-3 px-6 border-[1px] rounded-sm flex items-center gap-2">
                  <input
                    ...
                    class="w-full bg-transparent outline-none placeholder:text-xs"
                  />
                </div>
                <div class="relative p-3 px-6 border-[1px] rounded-sm flex items-center gap-2">
                  <input
                ...
                <button
                  type="submit"
                  class="p-3 px-12 text-center text-white rounded-sm bg-primary"
                >
                  تایید و پرداخت
                </button>
              </form>
            ...
            <div class="flex flex-col text-sm md:bg-white md:px-8 md:py-4 rounded-md lg:border-[1px] gap-4 w-full md:text-xs lg:text-sm">
              <h2 class="font-bold">تاریخچه واریزها</h2>

              <div class="items-center justify-between text-center gap-4 p-4 hidden md:flex">
                <p class="w-3/12">تاریخ</p>
                <p class="w-1/12">نوع واریز</p>
                <p class="w-2/12">مقدار واریزی (تومان)</p>
                <p class="w-2/12">وضعیت</p>
                <span class="w-4/12">شماره پیگیری</span>
              </div>
              <div class="md:flex md:flex-col md:gap-2 rounded-md shadow-sm md:shadow-none">
                <div class="flex flex-col gap-8 p-4 md:p-0 md:gap-2 text-center border-b-[1px] last:border-none md:border-none md:flex-row md:items-center md:justify-between md:py-0">
                  <div class="flex items-center justify-between md:justify-center md:w-3/12">
                    <span class="py-2 px-8 bg-success-bg w-24 text-success-text text-center md:hidden">
                      موفق
                    </span>
                    <span>۱۴:۲۵:۰۰ - ۱۴۰۰/۰۵/۱۰</span>
                  </div>
                  <div class="flex justify-between md:justify-center text-sm md:w-1/12">
                    <p class="text-lowgray md:hidden">نوع واریز</p>
                    <p>واریز شتابی</p>
                  </div>
                  <div class="flex justify-between md:justify-center text-sm md:w-2/12">
                    <p class="text-lowgray md:hidden">مقدار واریزی (تومان)</p>
                    <p>۵۴۳٬۰۰۰</p>
                  </div>
                  <div class="hidden md:flex justify-between md:justify-center text-sm md:w-2/12">
                    <p class="text-lowgray md:hidden">مقدار واریزی (تومان)</p>
                    <span class="py-2 px-8 bg-success-bg w-24 text-success-text text-center">
                      موفق
                    </span>
                  </div>
                  <div class="flex justify-between md:justify-center text-sm md:w-4/12">
                    <p class="text-lowgray md:hidden">شماره پیگیری</p>
                    <p>502229107590758200000000</p>
                  </div>
                </div>
                <div class="flex flex-col gap-8 p-4 md:p-0 md:gap-2 text-center border-b-[1px] last:border-none md:border-none md:flex-row md:items-center md:justify-between md:py-0">
                  <div class="flex items-center justify-between md:justify-center md:w-3/12">
                    <span class="py-2 px-8 bg-danger-bg w-24 text-danger-text text-center md:hidden">
                      ناموفق
                    </span>
                    <span>۱۴:۲۵:۰۰ - ۱۴۰۰/۰۵/۱۰</span>
                  </div>
                  ...
                  <div class="hidden md:flex justify-between md:justify-center text-sm md:w-2/12">
                    <p class="text-lowgray md:hidden">مقدار واریزی (تومان)</p>
                    <span class="py-2 px-8 bg-danger-bg w-24 text-danger-text text-center">
                      ناموفق
                    </span>
                  </div>
                  <div class="flex justify-between md:justify-center text-sm md:w-4/12">
