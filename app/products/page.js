  ...
  return (
    <div>
      ...
      <main class="w-full p-6 mx-auto max-w-screen-2xl lg:px-12 xl:px-24">
        <section class="flex justify-center gap-4 mt-8 lg:justify-start">
          <aside
            id="dropdowns"
            class="mobile-category w-screen h-screen max-md:fixed max-md:top-0 max-md:pt-32 max-md:px-16 max-md:bg-white flex-col hidden lg:flex gap-6 lg:w-2/5 p-4 border-[1px] rounded-md lg:h-max"
          >
            <span class="flex items-center gap-2 pb-2 text-lg font-medium cursor-pointer mobile-category-btn max-md:pb-8">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
            ...
            <div class="group flex flex-col gap-4 border-b-[1px] last:border-none pb-4 last:pb-0">
              <div class="flex items-center justify-between">
                <span class="flex gap-1">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M12.5499 18.5601H9.10986C8.69986 18.5601 8.35986 18.2201 8.35986 17.8101C8.35986 17.4001 8.69986 17.0601 9.10986 17.0601H12.5499C12.9599 17.0601 13.2999 17.4001 13.2999 17.8101C13.2999 18.2201 12.9699 18.5601 12.5499 18.5601Z"
                      fill="#786AC2"
                    />
                  </svg>
                ...
                <div class="cursor-pointer action-button">
                  <svg
                    class="hidden group-[.active]:block"
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                  ...
                  <svg
                    class="block group-[.active]:hidden"
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
                    viewBox="0 0 24 24"
              ...
              <div class="hidden group-[.active]:flex flex-col gap-4 text-sm text-lowgray mt-2">
                <a href="#" class="flex items-center justify-between">
                  گیفت کارت اپل
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="grid items-start max-w-md grid-cols-2 gap-4 lg:grid-cols-3 md:max-w-xl lg:max-w-full h-max">
            <div class="flex items-center gap-1 text-sm font-medium cursor-pointer mobile-category-btn lg:hidden">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
            ...
            <div class="flex items-center gap-1 mb-8 text-sm font-medium cursor-pointer lg:col-span-3">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
            ...
            <a
              href="#"
              class="p-3 text-center transition-all duration-100 ease-linear bg-white rounded-md hover:shadow-md"
            >
              <img
