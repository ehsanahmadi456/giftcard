  ...
  return (
    <div>
      ...
      <main class="w-full mx-auto mb-12 max-w-screen-2xl">
        ...
        >
          <div class="relative col-span-2 row-span-2 overflow-hidden rounded-lg block z-10 bg-[url('../img/blog.png')] bg-cover bg-no-repeat bg-center before:content-[''] before:absolute before:inset-0 before:block before:bg-gradient-to-t before:from-slate-800 before:from-10% before:opacity-60 before:z-[-5]">
            <p class="absolute text-xl font-medium bottom-6 right-6">
              بررسی ایکس باکس سری اس مایکروسافت
            </p>
          </div>
          <div class="relative overflow-hidden rounded-lg block z-10 bg-[url('../img/blog.png')] bg-cover bg-no-repeat bg-center before:content-[''] before:absolute before:inset-0 before:block before:bg-gradient-to-t before:from-slate-800 before:from-10% before:opacity-60 before:z-[-5]">
        ...
        <section id="new-cat" class="p-6 mt-8 lg:px-12 xl:px-24">
          <h4 class="mb-8 text-lg font-medium text-lowgray">
            جدیدترین های تکنولوژی
          </h4>
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 sm:gap-4">
            <article class="flex flex-col cursor-pointer gap-4 p-6 overflow-hidden transition-all duration-100 ease-linear sm:rounded-lg sm:bg-white sm:max-w-md sm:p-0 hover:shadow-md">
              <img
