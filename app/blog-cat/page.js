      ...
      <main className="w-full mx-auto mb-12 max-w-screen-2xl">
        ...
        <section id="new-cat" className="p-6 mt-8 lg:px-12 xl:px-24">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 sm:gap-4">
            <article className="flex flex-col cursor-pointer gap-4 p-6 overflow-hidden transition-all duration-100 ease-linear sm:rounded-lg sm:bg-white sm:max-w-md sm:p-0 hover:shadow-md">
              <img
